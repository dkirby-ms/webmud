...
module resources 'resources.bicep' = {
  ...
  params: {
    ...
    gameServiceExists: gameServiceExists
...
output AZURE_RESOURCE_GAME_SERVICE_ID string = resources.outputs.AZURE_RESOURCE_GAME_SERVICE_ID
output AZURE_RESOURCE_WEBMUD_CLIENT_ID string = resources.outputs.AZURE_RESOURCE_WEBMUD_CLIENT_ID
